...
<html lang="en">
	<head>
		<title>MY V Bike rental</title>
			...
			<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?v=3.26&sensor=false"></script>
		...
		<header>
			...
			<a name="top"></a> 
				...
				<ul class="topnav" id="myTopnav">
					<li class="leftMenuItem"><a href="index.html" id="home"><strong>Home</strong></a></li>
					<li class="leftMenuItem"><a href="price.html" id="price"><strong>Prices</strong></a></li>
					<li class="leftMenuItem"><a href="reservation.html" id="reservation"><strong>Rent</strong></a></li>
					<li class="leftMenuItem"><a class="active" href="contact.html" id="contacts"><strong>Contact</strong></a></li>
				</ul>
				
				<div id="mySidenav" class="sidenav">
				  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
				  <a href="index.html" id="home">Home</a>
				  <a href="price.html" id="price">Prices</a>
				  <a href="reservation.html" id="reservation">Rent</a>
				  <a href="contact.html" id="contacts">Contact</a>
				</div>
				
				<a class="toggle" href="javascript:void(0);" onclick="openNav()">
					...
					<form class="form-horizontal" role="form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
						...
						<div class="col-sm-12" id="columns">
							<div class="col-sm-6 form-group">
								<label for="first-name" class="col-sm-6 control-label"><span class="required">*</span> First Name:</label>
								<div class="col-sm-12">
									<input type="text" class="form-control" id="first-name" name="first-name" placeholder="First Name" value="<?php echo $name;?>">
									<span class="required small"><?php echo $errName;?></span> 
								</div>
							</div>
						
							<div class="col-sm-6 form-group">
								<label for="last-name" class="col-sm-6 control-label"><span class="required">*</span> Last Name:</label>
								<div class="col-sm-12">
									<input type="text" class="form-control" id="last-name" name="last-name" placeholder="Last Name" value="<?php echo $name;?>">
									<span class="required small"><?php echo $errName;?></span> 
								</div>
							</div>
						</div>
